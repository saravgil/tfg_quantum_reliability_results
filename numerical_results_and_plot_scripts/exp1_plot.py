...
# Structure:
# grouped_data[(Nqubit, Npar)][distance][Fth] = reliability
# ======================================================
grouped_data = {}
...
for filename in files:
    ...
    if d not in grouped_data[key]:
        grouped_data[key][d] = {}

    grouped_data[key][d][Fth] = R
...
# All distances and fidelities present in the dataset
all_distances = sorted(list(set(
    float(np.load(os.path.join(folder_name, f))["distance_km"]) for f in files
)))
...
# ======================================================
for (Nqubit, Npar), distance_dict in grouped_data.items():
...
# Save and show
# ======================================================
output_png = "exp1_reliability_vs_fth.png"
output_pdf = "exp1_reliability_vs_fth.pdf"
